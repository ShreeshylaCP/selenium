...
public class ToMoveToAParticularElement {
	...
	public static void main(String[] args) {
		...
		WebElement elementToBeScrolled = driver.findElement(By.linkText("View all companies"));
		
		JavascriptExecutor js = (JavascriptExecutor) driver;
		
		js.executeScript("arguments[0].scrollIntoView(false);", elementToBeScrolled);
		//js.executeScript("arguments[0].scrollIntoView();", elementToBeScrolled);
